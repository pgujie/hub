                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="owner" name="owner" class="form-control form-control-alternative {{ $errors->has('owner') ? ' is-invalid' : '' }}"  value="{{ old('owner') }}">
                                            @if ($errors->has('owner'))
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="agent" id="agent" class="form-control form-control-alternative {{ $errors->has('agent') ? ' is-invalid' : '' }}" value="{{ old('agent') }}" type="text">
                                            @if ($errors->has('agent'))
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group focused">
                                            ...
                                            <select class="form-control form-control-alternative {{ $errors->has('owner') ? ' is-invalid' : '' }}"  name="type" id="type">
                                                ...
                                                <option value="listed" {{ old('type') == 'listed' ? 'selected' : '' }}> Listed Property</option>
                                                <option value="un-listed" {{ old('type') == 'un-listed' ? 'selected' : '' }}>Un-Listed Property</option>
                                            </select>
                                            @if ($errors->has('type'))
                                                <span class="invalid-feedback" role="alert">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group focused">
                                            ...
                                            <input id="address" name="address" class="form-control form-control-alternative {{ $errors->has('address') ? ' is-invalid' : '' }}"  value="{{ old('address') }}" type="text">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group focused">
                                            ...
                                            <input id="lat" name="lat" class="form-control form-control-alternative {{ $errors->has('lat') ? ' is-invalid' : '' }}"  value="{{ old('lat') }}" type="text">
                                            @if ($errors->has('lat'))
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="long" name="long" class="form-control form-control-alternative {{ $errors->has('long') ? ' is-invalid' : '' }}"  value="{{ old('long') }}" type="text">
                                            @if ($errors->has('long'))
                                                <span class="invalid-feedback" role="alert">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group focused">
                                            ...
                                            <input id="suburb"  name="suburb" class="form-control form-control-alternative {{ $errors->has('suburb') ? ' is-invalid' : '' }}"  value="{{ old('suburb') }}" type="text">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="city" id="city" class="form-control form-control-alternative {{ $errors->has('city') ? ' is-invalid' : '' }}"  value="{{ old('city') }}" type="text">
                                            @if ($errors->has('city'))
                                                <span class="invalid-feedback" role="alert">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group focused">
                                            ...
                                            <input id="province" name="province" class="form-control form-control-alternative {{ $errors->has('province') ? ' is-invalid' : '' }}"  value="{{ old('province') }}"  type="text">
